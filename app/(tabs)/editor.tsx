...
export default function EditorScreen() {
  ...
  const [jasmimFullscreen, setJasmimFullscreen] = useState(false);
      ...
      <View style={{ flex: 1, flexDirection: "row", overflow: "hidden" }}>
        ...
        <Animated.View
          style={[styles.aiPanel, {
            width: jasmimFullscreen ? SCREEN_WIDTH : AI_PANEL_WIDTH,
            backgroundColor: colors.card,
        ...
        >
          ...
          <View style={[styles.aiPanelHeader, { borderBottomColor: colors.border, paddingTop: 14 }]}>
            ...
            <TouchableOpacity
              onPress={() => {
                setJasmimFullscreen(v => !v);
                Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
              }}
              hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }}
              style={{ marginRight: 6, padding: 4, borderRadius: 6, backgroundColor: jasmimFullscreen ? "#7c3aed22" : "transparent" }}
            >
              <Feather name={jasmimFullscreen ? "minimize-2" : "maximize-2"} size={16} color={jasmimFullscreen ? "#7c3aed" : colors.mutedForeground} />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => { setShowAI(false); setJasmimFullscreen(false); }} hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }}>
